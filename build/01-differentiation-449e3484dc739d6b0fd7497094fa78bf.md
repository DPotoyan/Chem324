...
- **Special limits.** A handful of limits involving sine, cosine, and the number $e$ underlie the derivatives of trigonometric and exponential functions.
- **A table of common derivatives.** A quick reference for the derivatives you will use throughout the course.
:::
...
| $e$ as a limit | $e = \lim\limits_{n\to \infty} (1+\frac{1}{n})^{n}$ |
