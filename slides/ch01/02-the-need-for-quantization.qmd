...
- Energy at frequency $\nu$ = **average energy** of one wave $\times$ **number of waves** of that frequency
- **Factor 1** is thermodynamics: what the waves are, how much energy each holds. This is where classical and quantum physics part ways
- **Factor 2** is geometry: how many standing waves fit in a box. Same classically and quantum

## Factor 1, the classical way: vibrating atoms
...
## Factor 2: counting the waves in a box
...
- Factor 2 is solid geometry, so **factor 1 must be wrong**
:::
::::
...
## Planck's law: same recipe, new factor 1
...
::: {.fragment}
Energy per mode $\times$ modes, with factor 2 untouched:
$$\rho_{\nu}(T) = \frac{8\pi \nu^2}{c^3} \cdot \frac{h\nu}{e^{\frac{h\nu}{kT}} - 1}$$
