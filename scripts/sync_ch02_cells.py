"""Copy each animation/still from scripts/make_ch02_animations.py into the lecture pages.
...
`plt.show()`. Run from the repo root:  .venv/bin/python scripts/sync_ch02_cells.py
"""
import importlib.util, inspect, re, sys, textwrap

PAGES = ["ch02/01-waves.md", "ch02/02-the-wave-equation.md"]
HEADER = (
    "import numpy as np\n"
...
spec = importlib.util.spec_from_file_location("ch02anim", "scripts/make_ch02_animations.py")
