...
- **Lecture pages** (markdown) carry the core theory, figures, and worked examples.
- **Demo pages** (notebooks) carry interactive Python you can run and modify.

Start with [Chapter 1](ch01/00-index.md).
