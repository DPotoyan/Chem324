...
- Atoms and molecules exchange energy with the environment by jumping from one state Em to another En. The energy difference between these levels  $E_m-E_n=hv$ is either supplied by light (absorption) or used to generate light (emission).
